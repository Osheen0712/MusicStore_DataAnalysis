...
SELECT billing_country as Country ,count(*) as Total_No_Of_Invoices 
FROM invoice
GROUP BY Country
...
-- Write a query that returns each country along with the top Genre.For countries where the maximum number of purchases is shared return ll Genres.
